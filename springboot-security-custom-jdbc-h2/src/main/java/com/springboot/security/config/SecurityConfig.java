    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.jdbcAuthentication() //using jdbc authetication
                ...
                .usersByUsernameQuery("select u.username,u.password,u.enabled" +
                                              " from Users u where u.username = ?")//Here we can also use custom schema as opposed to the default schema provided by springboot
                .authoritiesByUsernameQuery("select a.username,a.authority" +
